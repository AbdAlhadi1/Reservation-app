...
import 'package:reservationapp/Car%20Service/Widget/Book%20Car.dart';

import '../../Classes/User.dart';
import '../../my_field.dart';


class CarReservationPage extends StatefulWidget {
  User user;
  String price;
  int carId,carCompanyId;
  String city;
  CarReservationPage({super.key,required this.price,required this.user,required this.carCompanyId,required this.carId,required this.city});

  @override
  State<CarReservationPage> createState() => _CarReservationPageState();
}

class _CarReservationPageState extends State<CarReservationPage> {
  TextEditingController startDateController = TextEditingController();
  TextEditingController endDateController = TextEditingController();
  TextEditingController confirmReservation = TextEditingController();
  TextEditingController receivingLocation = TextEditingController();
  ...
  void initState() {
    switch(widget.city){
      case "Latakia":
        setState(() {
          receivingLocation.text = "Awkaf Street";
        });
        setState(() {
          deliveryLocation.text ="Awkaf Street";
        });
        break;
      case "Damascus":
        setState(() {
          receivingLocation.text = "Bagdad Street";
        });
        setState(() {
          deliveryLocation.text = "Bagdad Street";
        });
        break;
      case "Tartus":
        setState(() {
          receivingLocation.text = "Al-Thawra Street";
        });
        setState(() {
          deliveryLocation.text ="Al-Thawra Street";
        });
        break;
      case "Aleppo" :
        setState(() {
          receivingLocation.text = "King Faisal Street";
        });
        setState(() {
          deliveryLocation.text = "King Faisal Street";
        });
        break;
      default:
        break;
    ...
    return SafeArea(
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text("MR Car",style: TextStyle(
              color: thirdColor,
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(left: 25),
                    child: Text("Receiving Location",style: TextStyle(
                        color: mainColor
                    ),),
                  ),
                  MyFild(
                    inputTextColor: Colors.black,
                    preffixIcon: Icon(Icons.location_on,size: 22,color: secondColor,),
                    contorller: receivingLocation,
                    hintText: "Receiving Location",
                    obscure: false,
                    borderRadius: BorderRadius.circular(12),
                    readOnly: true,
                    rightPadding: 20.0,
              ...
              Column(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(left: 25),
                    child: Text("Delivery Location",style: TextStyle(
                        color: mainColor
                    ),),
                  ),
                  MyFild(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ElevatedButton(onPressed: (){
                                            ...
                                            if(check()) {
                                              Navigator.of(context).push(MaterialPageRoute(builder: (context)=>BookCar(user: widget.user, carId: widget.carId, carCompanyId: widget.carCompanyId, startDate: startDateController, endDate: endDateController, picLocation: receivingLocation, delLocation: deliveryLocation)));
                                            }
                                            }
